...
class Profile(TimeStampedModel):
    ...
    phone_number = PhoneNumberField(verbose_name = _("phone number"), max_length = 13, default = "+989138402864")
    ...
    city = models.CharField(verbose_name = _("city"), max_length = 180, default = "Tehran", blank = False, null = False)
    ...
    def check_following(self, profile):
        """
        This method checks if the given profile is in the followers list of the current profile.
        """
